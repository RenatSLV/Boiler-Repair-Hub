      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            aria-label="Меню"
          >
            <div className={`w-6 h-0.5 mb-1.5 transition-all ${scrolled ? "bg-gray-900" : "bg-white"}`}></div>
            <div className={`w-6 h-0.5 mb-1.5 transition-all ${scrolled ? "bg-gray-900" : "bg-white"}`}></div>
            <div className={`w-6 h-0.5 transition-all ${scrolled ? "bg-gray-900" : "bg-white"}`}></div>
          </button>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-up">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-white/90 text-sm font-medium">Работаем 24/7</span>
            </div>
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-lg">
              Быстрый выезд мастера. Работаем без выходных. Гарантия на все виды работ.
            </p>
          ...
          <div className="hidden lg:flex justify-end animate-fade-in">
            <div className="relative">
              <div className="w-80 h-80 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center">
                <svg className="w-48 h-48 text-blue-300/60" viewBox="0 0 200 200" fill="none">
                  <rect x="60" y="30" width="80" height="120" rx="8" fill="currentColor" opacity="0.3"/>
                  <rect x="75" y="45" width="50" height="30" rx="4" fill="currentColor" opacity="0.5"/>
                  <circle cx="100" cy="110" r="20" stroke="currentColor" strokeWidth="3" opacity="0.6"/>
                  <circle cx="100" cy="110" r="10" fill="currentColor" opacity="0.4"/>
                  <rect x="85" y="155" width="30" height="15" rx="3" fill="currentColor" opacity="0.3"/>
                  <path d="M 60 150 L 60 170 L 140 170 L 140 150" stroke="currentColor" strokeWidth="3" opacity="0.4"/>
                  <path d="M 40 80 L 60 80" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.5"/>
                  <path d="M 140 80 L 160 80" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.5"/>
                  <path d="M 40 100 L 60 100" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.4"/>
                  <path d="M 140 100 L 160 100" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.4"/>
                  <path d="M 40 120 L 60 120" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.3"/>
                  <path d="M 140 120 L 160 120" stroke="currentColor" strokeWidth="3" strokeLinecap="round" opacity="0.3"/>
                </svg>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl px-4 py-3 shadow-xl">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800 text-sm font-semibold">Мастер свободен</span>
                </div>
                <div className="text-gray-500 text-xs mt-0.5">Готов к выезду</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="text-center mb-16">
            <span className="text-orange-500 font-semibold text-sm uppercase tracking-widest">О компании</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">
              Надёжный партнёр
              <span className="text-blue-700"> в мире газового оборудования</span>
            </h2>
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto text-lg">
              Мы специализируемся на ремонте и обслуживании газовых котлов и систем отопления. 
              Наша команда поможет вам быстро и качественно.
            </p>
          </div>
  ...
  return (
    <section id="services" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="text-center mb-16">
            <span className="text-orange-500 font-semibold text-sm uppercase tracking-widest">Что мы делаем</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">
              Наши услуги
            </h2>
            <p className="text-gray-500 mt-4 max-w-xl mx-auto">
              Полный спектр услуг по ремонту и обслуживанию газового оборудования
            </p>
          </div>
              ...
              >
                {s.tag && (
                  <span className={`absolute top-4 right-4 text-xs font-bold px-2.5 py-1 rounded-full ${
                    s.tag === "Срочно" ? "bg-red-50 text-red-600" : "bg-blue-50 text-blue-600"
                  }`}>
                    {s.tag}
                  </span>
                )}
            ...
            {cards.map((c, i) => (
              ...
              >
                <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center text-2xl group-hover:bg-blue-700 group-hover:text-white transition-all duration-300">
                  <span className="group-hover:grayscale-0 transition-all">{c.icon}</span>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 text-base mb-1.5">{c.title}</h3>
  ...
  return (
    <section id="how" className="py-24 hero-gradient relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="text-center mb-16">
            <span className="text-orange-400 font-semibold text-sm uppercase tracking-widest">Процесс работы</span>
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 h-full hover:bg-white/15 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-4xl font-black text-white/20">{step.num}</span>
                  </div>
    ...
    <section id="form" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-orange-500 font-semibold text-sm uppercase tracking-widest">Заявка</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2 mb-4">
                Оставьте заявку — перезвоним за 5 минут
              </h2>
              <p className="text-gray-500 text-lg mb-8">
                Заполните форму, и наш мастер свяжется с вами в ближайшее время для уточнения деталей и согласования времени выезда.
              </p>

              <div className="space-y-4">
                {[
                  { icon: "📞", text: "Бесплатная консультация специалиста" },
                  { icon: "🕐", text: "Выезд мастера в течение 60 минут" },
                  { icon: "💳", text: "Диагностика и точная стоимость до работ" },
                  { icon: "📋", text: "Официальный договор и гарантийный талон" },
                ].map((item, i) => (
              ...
              <div className="mt-8 flex items-center gap-4">
                <a
                  href={`tel:${PHONE}`}
                  className="flex items-center gap-2 bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl hover:bg-blue-800 transition-all"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Наш мастер свяжется с вами в течение 5 минут</p>
                  <button
                    className="mt-6 text-blue-700 font-medium underline underline-offset-4"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={form.comment}
                        onChange={handleChange}
                        placeholder="Опишите проблему с котлом..."
                        rows={4}
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full orange-btn text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {loading ? (
                        <>
                    ...
                    <p className="text-xs text-gray-400 text-center">
                      ...
                      <a href="#" className="underline hover:text-gray-600">политикой обработки персональных данных</a>
                    </p>
                  </form>
                </>
              )}
    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Профессиональный ремонт и обслуживание газовых котлов и оборудования любой сложности.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {["Ремонт котлов", "Диагностика", "Установка", "Обслуживание", "Чистка", "Срочный ремонт"].map(s => (
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-gray-400">Принимаем заявки в любое время суток</p>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-500">
            Ремонт газовых котлов в Москве и Московской области
          </p>
        </div>
      </div>
    </footer>
...
export default function Landing() {
  useEffect(() => {
    ...
    if (meta) {
      meta.setAttribute("content", "Профессиональный ремонт газовых котлов любой сложности. Быстрый выезд мастера в течение 60 минут. Работаем 24/7. Гарантия на все виды работ. Звоните!");
    } else {
      const newMeta = document.createElement("meta");
      newMeta.name = "description";
      newMeta.content = "Профессиональный ремонт газовых котлов любой сложности. Быстрый выезд мастера в течение 60 минут. Работаем 24/7. Гарантия на все виды работ. Звоните!";
